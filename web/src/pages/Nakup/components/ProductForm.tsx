...
export const ProductForm = ({
    ...
    return (
        <div className="bg-white p-4 rounded-3xl shadow-lg shadow-gray-200/50 border border-gray-100 relative mb-8 z-20">
            ...
            <div className="relative">
                ...
                {/* Reset křížek pro vybraný produkt */}
                {vybranyProdukt && (
                     <button 
                        onClick={onCancel}
            ...
            {vybranyProdukt && (
                <div className="mt-5 pt-4 border-t border-gray-100 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    <div className="flex gap-3 items-stretch h-12">
                        ...
                        <button 
                            onClick={onConfirm} 
                            className="flex-1 bg-primary text-white rounded-xl font-semibold text-sm shadow-lg shadow-blue-500/30 active:scale-95 transition-transform flex items-center justify-center gap-2"
                        >
                            {vybranyProdukt.id === 'custom-item' ? 'Vytvořit' : 'Vložit do košíku'}
                        </button>
                    </div>
                </div>
            )}
